...
// currentColor is the same solid little bubble on every platform, and its
// tail points back at the words like the gutter's old manicule did.
export const BUBBLE_SVG =
  '<svg class="bubble" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">' +
